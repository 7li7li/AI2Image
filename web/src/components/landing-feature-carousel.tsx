...
const productFeatures: Array<{
...
}> = [
  {
    ...
    image: "/landing-features/annotation-edit.svg",
    imageAlt: "批注修改功能图片占位",
    icon: PenTool,
  ...
  },
  {
    ...
    image: "/landing-features/transparent-png.svg",
    imageAlt: "透明 PNG 功能图片占位",
    icon: Layers,
  ...
  },
  {
    ...
    image: "/landing-features/quick-tools.svg",
    imageAlt: "内置快捷工具功能图片占位",
    icon: Wrench,
  ...
  },
  {
    ...
    image: "/landing-features/prompt-library.svg",
    imageAlt: "提示词管理功能图片占位",
    icon: BookOpenText,
  ...
  },
  {
    ...
    image: "/landing-features/image-gallery.svg",
    imageAlt: "图库功能图片占位",
    icon: Images,
