...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  return {
    ...
    telegram_error_notifications_enabled: Boolean(config.telegram_error_notifications_enabled),
    telegram_bot_token: "",
    telegram_bot_token_set: Boolean(config.telegram_bot_token_set),
    telegram_chat_id: typeof config.telegram_chat_id === "string" ? config.telegram_chat_id : "",
    telegram_error_notifications_configured: Boolean(config.telegram_error_notifications_configured),
  ...
  saveConfig: async () => {
    ...
    try {
      const payload: Partial<SettingsConfig> = {
        ...
        telegram_chat_id: String(config.telegram_chat_id || "").trim(),
